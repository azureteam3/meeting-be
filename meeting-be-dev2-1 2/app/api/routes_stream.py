...
async def websocket_stream(
    ...
    preferred_language = websocket.query_params.get(
        "language"
    )
    ...
    if username or preferred_language:
        ...
        if preferred_language:
            metadata["language"] = preferred_language
...
async def handle_client_message(
    ...
    async def push_translation_update(websocket, segment_id, ko, translations=None):
        await websocket.send_json({
