...
class SpeechTranscriberService:
    ...
    def __init__(
        ...
        auto_detect_languages = self._build_auto_detect_languages(
            preferred_language
        )
    ...
    def _build_auto_detect_languages(
        self,
        ...
        preferred_locale = language_map.get(
        ...
        if preferred_locale not in configured_languages:
            return configured_languages

        remaining_languages = [
            language
            for language in configured_languages
            if language != preferred_locale
        ]
